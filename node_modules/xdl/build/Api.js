...
let _downloadAsync = (() => {
  var _ref3 = _asyncToGenerator(function* (url, path, progressFunction, retryFunction) {
    ...
    if (!(0, (_EnvironmentHelper || _load_EnvironmentHelper()).isNode)()) {
      ...
      yield (_fsExtra || _load_fsExtra()).default.promise.writeFile(path, Buffer.from(response.data));
      clearTimeout(warningTimer);
    } else {
      config = {
        timeout: TIMEOUT,

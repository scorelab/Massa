...
${renderUnversionedReactDependency(options, sdkVersion)}
${renderUnversionedYogaDependency(options, sdkVersion)}
${renderUnversionedThirdPartyDependency('DoubleConversion', _path.default.join('third-party-podspecs', 'DoubleConversion.podspec'), options)}
${renderUnversionedThirdPartyDependency('Folly', _path.default.join('third-party-podspecs', 'Folly.podspec'), options)}
${renderUnversionedThirdPartyDependency('GLog', _path.default.join('third-party-podspecs', 'GLog.podspec'), options)}
`, 2);
  }
}
